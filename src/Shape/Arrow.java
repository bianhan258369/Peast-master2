...
public class Arrow extends JPanel implements Serializable {
    ...
    public void paintComponent(int x1, int y1, int x2,int y2, Graphics g) {
    ...
    public static void drawAL(int sx, int sy, int ex, int ey, Graphics2D g2)
    {
        ...
        y4 = Y4.intValue();
        // 画线
        g2.setStroke(new BasicStroke(1.0F, 0, 0, 10.0F, Data.LENGTHOFDASH, 0.0F));
